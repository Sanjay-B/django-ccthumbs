...
def generate_thumb(img, thumb_size, format):
    """
    Generates a thumbnail image and returns a ContentFile
    object with the thumbnail
...
class ImageWithThumbsField(ImageField):
    ...
    available filenames with this format "any_filename.[width]x[height].jpg"
...
# add the introspection rules for souh
